            ...
            <div class="case-item">
                ...
                <div class="side-text">
                    ...
                    <div class="singleFeature">
                        ...
                        <h3>Задачи</h3>
                        <p>
                        Привлечение заявок на получение оптового коммерческого предложение через Google Adwords и Яндекс.Директ (тест в Украине).
                        </p>
                    </div>
                    <div class="singleFeature">
                        ...
                        <p>
                        Цена за конверсию:
Google Adwords 	18,2 грн. ($0,7)
Яндекс.Директ	 34,55 грн. ($1,35)
                        </p>
                    </div>
                </div>
            </div>
